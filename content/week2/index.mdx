...
```mermaid
flowchart TD
    Hook["0. Hook · 30초<br/>내일 아침 '송곳 한 줄' 메일 데모"]
    ...
    S6["6. 스케줄 v1 · 15분<br/>'송곳 한 줄' 메일 + 메타인지 1줄 + 액션 1줄"]
    Park["📌 다음 주 후보<br/>메타인지 지도 · 방향 검토 · '송곳 한 줄' 풀스케일"]
...
<Card title="5. 송곳 한 줄" icon="🎯" href="/week2/awl" meta="15분 · 매일 아침 도착하는 v1">
`/schedule`로 매일 아침 outbox·.ai-wiki를 읽고 숫자 3개 + 오늘 박을 송곳 한 줄을 본인에게 보냄. 안 봐도 그만인 뉴스레터가 아니라 약속.
</Card>
